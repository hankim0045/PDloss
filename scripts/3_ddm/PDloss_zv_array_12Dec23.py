#####################################################################################
# PDloss zv model (Run on 12 Dec 2023; n = 48; samples = 30000)
...
## Specify model
db_filename = (f'PDloss_zv_12Dec23_{iteration}.db')
model_filename = (f'PDloss_zv_12Dec23_{iteration}')
...
print("Model DIC: %f" % zv_model.dic)


## Compute DICc (deviance information criterion, corrected)
DICc = zv_model.dic_info['deviance'] + zv_model.dic_info['pD'] + zv_model.dic_info['pD']
